...
const CookieConsent = () => {
  ...
  return (
    <div id="cookies-simple-with-icon-and-dismiss-button" className="fixed bottom-0 end-0 z-[60] sm:max-w-sm w-full mx-auto p-6">
      <div className="p-4 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div className="flex gap-x-4">
            
            <svg className="flex-shrink-0 w-8 h-auto" width="72" height="63" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.5174 56.1528C16.2903 57.6825 16.929 61.4559 14.8118 60.9459C13.5013 60.5381 11.4445 57.6213 12.493 56.1528C12.661 55.8468 13.2189 55.2757 14.106 55.4389" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
                <path d="M15.5173 49.6263L14.0262 48.5579C13.5346 48.2056 12.8477 48.3707 12.658 48.945C12.3456 49.8907 12.1258 51.1463 12.462 52.2324C12.5336 52.4636 12.7127 52.6466 12.9449 52.7146C13.8342 52.9751 15.2568 52.9048 15.8197 51.054" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
                ...
                <path d="M31.6479 50.2383C31.5807 51.2241 32.1721 53.053 35.0756 52.4819" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
                <path d="M50.9903 34.6769C50.1699 34.1428 48.3973 33.5907 47.8709 35.6552" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
                <path d="M40.9087 17.4562C40.0882 16.9221 38.3156 16.37 37.7892 18.4345" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
                <path d="M27.8502 29.3345C27.1279 29.998 26.1419 31.587 27.977 32.6357" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
                <path d="M62.1917 19.585C62.4894 18.6451 62.5577 16.7703 60.4502 16.7902" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
                ...
                <path d="M56.9526 54.9284C57.7592 53.5006 60.2795 51.0735 65.1187 49.9313C66.0596 49.7953 67.9818 48.5647 68.1431 44.7302C68.3448 39.9371 73.5872 32.9003 69.3529 28.1072C67.5382 26.053 68.4456 23.2121 67.5382 17.7051" stroke="currentColor" className="dark:stroke-gray-200" strokeWidth="2" strokeLinecap="round"/>
            ...
            <p className="text-sm text-gray-800 dark:text-gray-200">
                By browsing this website, you accept our <a className="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline font-medium" href="#">Cookies Policy</a>
            </p>
            <button onClick={handleDismiss} type="button" className="p-2 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
